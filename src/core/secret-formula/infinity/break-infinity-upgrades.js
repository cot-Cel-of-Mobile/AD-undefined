...
export const breakInfinityUpgrades = {
  totalAMMult: {
    ...
    effect: () => player.records.totalAntimatter.exponent + 1,
  ...
  currentAMMult: {
    ...
    effect: () => Currency.antimatter.exponent + 1,
    formatEffect: value => formatX(value, 2, 2)
  },
  galaxyBoost: {
    id: "postGalaxy",
  ...
  achievementMult: {
    ...
    effect: () => Math.max(Math.pow((Achievements.effectiveCount), 3) / 40, 1),
    // Removed the -30 from Achievements.effectiveCount, this is roughly 2.11x better with 136 achievements (rows 1-17)
    formatEffect: value => formatX(value, 2, 2)
  },
  slowestChallengeMult: {
    ...
    effect: () => Decimal.clampMin(1000 / Time.worstChallenge.totalMinutes, 1),
    formatEffect: value => formatX(value, 2, 2),
    hasCap: true,
    cap: DC.D6E4
  },
