export const ra = {
  pets: {
    teresa: {
      ...
      rawMemoryChunksPerSecond: () => 400 * Math.pow(Currency.eternityPoints.value.pLog10() / 1e4, 3),
    ...
    effarig: {
      ...
      rawMemoryChunksPerSecond: () => 400 * Math.pow(Effarig.shardsGained, 0.1),
    ...
    enslaved: {
      ...
      rawMemoryChunksPerSecond: () => 400 * Math.pow(Currency.timeShards.value.pLog10() / 3e5, 2),
    ...
    v: {
      ...
      rawMemoryChunksPerSecond: () => 400 * Math.pow(Currency.infinityPower.value.pLog10() / 1e7, 1.5),
